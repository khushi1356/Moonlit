  ...
  return (
    <Helmet>
      ...
      <script type="application/ld+json">
        {`{"@context":"https://schema.org","@type":"BeautySalon","name":"${name}","image":"${image}","url":"${url}","telephone":"+15551234567","address":{"@type":"PostalAddress","streetAddress":"123 Serenity Avenue","addressLocality":"Beverly Hills","addressRegion":"CA","postalCode":"90210","addressCountry":"US"},"priceRange":"$$$","description":"${description || "Premium Salon & Spa services for the modern aesthetic."}"}`}
      </script>
    </Helmet>
  );
};
